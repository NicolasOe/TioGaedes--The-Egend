...
EGantEscolhida byte 17 ;posicao da eg previamente escolhida
...
cmp edx,0
je ToTheEgend	; se não teve colisão não faz nada e recomeça o loop
jmp finalizar
...
INVOKE draw_matrix, OFFSET movement_undoing_3, 0604h, dx, RED+RED*16
jmp MPUEND
...
INVOKE draw_matrix, OFFSET movement_undoing_1, 0302h, dx, RED+RED*16
jmp MPUEND
...
INVOKE draw_matrix, OFFSET movement_undoing_2, 0602h, dx, RED+RED*16
jmp MPUEND

MPU3:
INVOKE draw_matrix, OFFSET movement_undoing_2, 0304h, dx, RED+RED*16
...
VazioEGEND:
mov MapCovered[edx], 2
mov MapCovered[edx+1], 2
mov MapCovered[edx+8], 2
mov MapCovered[edx+9], 2
